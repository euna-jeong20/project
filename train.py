...
from backbone import get_resent_fpn, get_pyramid_vig_fpn
from detector import retina_net, masrk_rcnn
import numpy as np
import random
...
def main(args):
    ...
    backbone = get_pyramid_vig_fpn()
    model = retina_net(backbone=backbone, num_classes=num_classes, use_fpn=True)
